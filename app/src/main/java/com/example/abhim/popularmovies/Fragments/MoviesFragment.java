...
public class MoviesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
       final View rootView = inflater.inflate(R.layout.mainfragment, container, false);
        moviesGridAdapter = new GridAdapter(getActivity());
...
//            //Rx-2 API CALL
////            asyncPopularMovies();
////            SharedPreferenceUtil.Companion.getSharedPrefsInstance(getContext()).edit().apply();
...
//        }
    ...
    private void asyncPopularMovies() {
//        new MoviesAsyncApi().getPopularMovies().subscribe(this::onSuccess, this::onErrorResponse);
    }

    private void onSuccess(ResultsResponseBody resultsResponseBody) {
    ...
    private void onErrorResponse(Throwable exception) {
